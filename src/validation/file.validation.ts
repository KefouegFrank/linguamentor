...
// Prisma enum values mirrored here to avoid direct build-time dependency
const FileTypeValues = ['AUDIO', 'VIDEO', 'IMAGE', 'DOCUMENT', 'OTHER'] as const;
...
export const processFileSchema = z.object({
  operation: z.enum(['transcribe', 'translate', 'summarize', 'convert', 'compress', 'extract']),
